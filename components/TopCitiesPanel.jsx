  ...
  return (
    <div className="rounded-xl border border-border bg-panel p-3">
      <div className="mb-2 flex items-center justify-between">
        <h3 className="text-xs font-semibold text-slate-200">Top Affected Cities</h3>
          ...
          {top.map((c) => {
            ...
            return (
              <div key={c.city} className="flex items-center gap-2">
                <div className="w-14 shrink-0 truncate text-[10px] text-slate-300">{c.city}</div>
                ...
                <div className="w-8 shrink-0 text-right text-[10px] font-semibold text-slate-200">
                  {c.count}
                </div>
              </div>
            );
